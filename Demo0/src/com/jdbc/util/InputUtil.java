...
public class InputUtil {
	...
	public static String acceptPetDetailsToUpdate(Scanner sc) {
		System.out.println("Enter updated name of pet:");
		return sc.next();
	}
	
	public static String acceptOwnerEmailIdToOperate(Scanner sc) {
		System.out.println("Enter email id of owner:");
		sc.nextLine();
		return sc.nextLine();
	}
	
	public static LocalDate acceptPetBirthDateToOperate(Scanner sc) {
		System.out.println("Enter date of birth of pet (dd-MM-yyyy):");
